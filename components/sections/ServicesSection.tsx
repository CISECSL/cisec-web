...
const services = [
  {
    ...
    description: "Auditoría manual de aplicaciones web siguiendo OWASP Top 10 y PTES. Detectamos lo que los scanners no ven.",
    price: "Desde 3.500€",
  ...
  },
  {
    ...
    description: "Evaluación de seguridad de redes, servidores y entornos cloud (AWS, GCP, Azure). Interno y externo.",
    price: "Desde 4.000€",
  ...
  },
  {
    icon: FileCheck,
    title: "Auditoría ENS",
    description: "Cumplimiento del Esquema Nacional de Seguridad. Gap analysis, auditoría técnica y acompañamiento.",
    price: "Consultar",
  ...
  },
  {
    ...
    description: "Contención, erradicación y forensic ante incidentes de ciberseguridad. Respuesta inicial en menos de 2 horas.",
    price: "Urgente 24h",
